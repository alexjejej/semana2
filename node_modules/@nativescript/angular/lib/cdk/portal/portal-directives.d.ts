 ...
 */
import { ComponentFactoryResolver, ComponentRef, EmbeddedViewRef, EventEmitter, OnDestroy, OnInit, TemplateRef, ViewContainerRef, Renderer2 } from '@angular/core';
...
export declare class CdkPortalOutlet extends BasePortalOutlet implements OnInit, OnDestroy {
    ...
    constructor(_componentFactoryResolver: ComponentFactoryResolver, _viewContainerRef: ViewContainerRef, renderer: Renderer2);
...
export declare class PortalModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<PortalModule, [typeof CdkPortal, typeof CdkPortalOutlet], never, [typeof CdkPortal, typeof CdkPortalOutlet]>;
